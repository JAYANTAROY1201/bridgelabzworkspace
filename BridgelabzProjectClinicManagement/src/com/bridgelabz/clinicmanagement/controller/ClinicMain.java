...
/**
 * Purpose: this class is designed to perform all the ask of clinic
 * @author Jayanta Roy
 * @version 1.0
 * @since 11/06/18
 */
	...
	public static void main(String[] args) {
		...
		while (quit == false) {
			...
			System.out.println("Enter choice:\n1 for ADD DOCTOR \n" + "2 for ADD PATIENT\n" + "3 for SHOW ALL DOCTORS\n"
					...
					+ "7 for TAKE APPOINTMENT\n" + "8 for SHOW POPULAR DOCTOR/SPECIALIZATION\n" + "Any other for exit");
